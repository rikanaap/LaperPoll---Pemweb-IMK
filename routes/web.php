...
// ── PROFIL PUBLIK (public — bisa diakses tanpa login) ────────────────────────
Route::get('/profile/public/{id}', [PublicProfileController::class, 'show'])->name('profile.public');

// ── FOLLOW — GET followers/following public, toggle butuh login ───────────────
