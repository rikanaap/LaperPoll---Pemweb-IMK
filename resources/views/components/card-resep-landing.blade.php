        ...
        <div class="flex flex-col gap-[0.1rem] items-start md:self-stretch">
            ...
            <div class="flex gap-[0.125rem] md:gap-[0.3]">
                ...
                <div class="relative">
                    ...
                    <span class="material-icons-round text-[0.125rem] text-white absolute top-1/2 left-1/2 right-1/2 bottom-1/2 md:text-[0.2rem] w-fit h-fit font-bold">check</span>
